...
- `data/raw/web/zenodo_egfr_gnn_dataset.csv` - **NOT UPLOADED** - The original Zenodo archive was not stored locally due to its large size (2.9 GB). Only the selectively extracted mutation CSV files were retained in `data/raw/web/extracted_zenodo/`.
